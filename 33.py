...
Original file is located at
    https://colab.research.google.com/drive/17F7cRIlTGUwrUKNKNUTRLl6PEfXRswQv
"""
...
def pipeline_model(path):
    ...
    # Mô tả kiến trúc
    faceDetectionProto = '/content/drive/MyDrive/test_opencv/models/deploy.prototxt.txt.prototxt'
...
img, results = pipeline_model('/content/drive/MyDrive/test_opencv/FaceImage/1721030881_ThanTrongPhuc/image_1080.jpg')
cv2_imshow(img)

img, results = pipeline_model('/content/drive/MyDrive/test_opencv/FaceImage/1721030943_DangMinhVu/image_20.jpg')
cv2_imshow(img)